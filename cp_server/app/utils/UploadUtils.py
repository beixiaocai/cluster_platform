            ...
            if file_size_m <= 20:
                if file_name.endswith(".jpg") or file_name.endswith(".png") or file_name.endswith(".jpeg"):
                    ...
                    if __suffix == "jpg":
                        ...
                        new_filename_abs = os.path.join(sample_dir, new_filename)
                        temp_image = Image.open(temp_new_filename_abs)
                        temp_image = temp_image.convert('RGB')
                        temp_image.save(new_filename_abs, 'JPEG')
        ...
        try:
            ...
            if file_size_m <= 500:
                if file_name.endswith(".avi") or file_name.endswith(".flv") or file_name.endswith(".mp4"):
                    ...
                    video_filename_abs = os.path.join(sample_dir, video_filename)
